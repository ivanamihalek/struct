...
int opt_quat (double ** x, int NX, int *set_of_directions_x, double ** y, int NY, int *set_of_directions_y,
	      int set_size, double * q, double * rmsd){
    
    int opt_quat_lapack (double ** x, int NX, int *set_of_directions_x, double ** y, int NY, int *set_of_directions_y,
			 int set_size, double * q, double * rmsd);
    int opt_quat_sine_lapack (double ** x, int NX, int *set_of_directions_x,
			      double ** y, int NY, int *set_of_directions_y,
			      int set_size, double * q, double * rmsd);

    return opt_quat_sine_lapack (x, NX, set_of_directions_x, y, NY, set_of_directions_y, 3, q, rmsd);
...
int direction_match (Representation* X_rep, Representation* Y_rep, List_of_maps *list){
    ...
    double avg = 0.0, avg_sq = 0.0, stdev = 1.0;
