...
int Link(HBOND **HBond, CHAIN **Chain, int Cn1, int Cn2, RESIDUE *Res1_1, 
	 ...
	 char *Text, float Treshold, StrideCmd *Cmd, int Test);
static void PrintPatterns(PATTERN **Pat, int NPat, CHAIN **Chain,
			  int Cn1, int Cn2);
static void Bridge(char *Asn1, char *Asn2, CHAIN **Chain, int Cn1, int Cn2,
		   PATTERN **Pat, int NPat);



void Sheet(CHAIN **Chain, int Cn1, int Cn2, HBOND **HBond,
